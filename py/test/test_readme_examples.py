# ZefoyTiktokBot SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ZefoyTiktokBotSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ZefoyTiktokBotSDK(...) and ZefoyTiktokBotSDK.test(...) become
#      ZefoyTiktokBotSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "zefoytiktokbot_sdk"
_SDK_CLASS = "ZefoyTiktokBotSDK"
