...
from zefoytiktokbot_sdk.utility import register

# Load features
from zefoytiktokbot_sdk.feature.base_feature import ZefoyTiktokBotBaseFeature
from zefoytiktokbot_sdk.features import _has_feature, _make_feature
...
class ZefoyTiktokBotSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = ZefoyTiktokBotUtility()
        self._utility = utility

        from zefoytiktokbot_sdk.config import shared_config
    ...
    def get_utility(self):
        return ZefoyTiktokBotUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("ZefoyTiktokBotSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Engagement(self, data=None) -> "EngagementEntity":
        ...
        from zefoytiktokbot_sdk.entity.engagement_entity import EngagementEntity
