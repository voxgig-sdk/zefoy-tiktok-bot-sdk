...
The Python SDK for the ZefoyTiktokBot API. Provides an entity-oriented interface following Pythonic conventions.
...
result, err = client.ZefoyTiktokBot(None).load(
    {"id": "test01"}, None
)
