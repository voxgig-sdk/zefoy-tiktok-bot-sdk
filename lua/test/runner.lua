...
function runner.env_override(m)
  local live = runner.getenv("ZEFOYTIKTOKBOT_TEST_LIVE")
  local override = runner.getenv("ZEFOYTIKTOKBOT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("ZEFOYTIKTOKBOT_TEST_EXPLAIN")
