...
func (sdk *ZefoyTiktokBotSDK) OptionsMap() map[string]any {
...
func (sdk *ZefoyTiktokBotSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *ZefoyTiktokBotSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *ZefoyTiktokBotSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ZefoyTiktokBotSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *ZefoyTiktokBotSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *ZefoyTiktokBotSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("ZefoyTiktokBotSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *ZefoyTiktokBotSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *ZefoyTiktokBotSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("ZefoyTiktokBotSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *ZefoyTiktokBotSDK {
	...
	sdk := NewZefoyTiktokBotSDK(sdkopts)
	sdk.Mode = "test"
