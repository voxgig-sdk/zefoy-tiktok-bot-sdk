# ZefoyTiktokBot Golang SDK Reference

Complete API reference for the ZefoyTiktokBot Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *ZefoyTiktokBotSDK`
...
#### `Engagement(data map[string]any) ZefoyTiktokBotEntity`
