...
// ZefoyTiktokBot SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (ZefoyTiktokBotSDK::test)
...
{
    private const SDK_CLASS = 'ZefoyTiktokBotSDK';
    ...
    private const SDK_BASE = 'zefoytiktokbot_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../zefoytiktokbot_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
