// Command ZefoyTiktokBot-mcp is an MCP server exposing the ZefoyTiktokBot
// SDK as MCP tools.
//
// Two tools are registered:
//
//	ZefoyTiktokBot_list  — list records of an entity
//	ZefoyTiktokBot_load  — load a single record of an entity
//
