...
func registerTools(server *mcp.Server, client *sdk.ZefoyTiktokBotSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "zefoy-tiktok-bot_list",
		Description: "List records from ZefoyTiktokBot. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "zefoy-tiktok-bot_load",
		Description: "Load a single record from ZefoyTiktokBot. " +
...
func runOp(client *sdk.ZefoyTiktokBotSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.ZefoyTiktokBotSDK, name string) (sdk.ZefoyTiktokBotEntity, error) {
