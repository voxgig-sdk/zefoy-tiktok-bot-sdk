...
func registerSDKWords(r *eng.Registry, client *sdk.ZefoyTiktokBotSDK) {
...
func runOp(client *sdk.ZefoyTiktokBotSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
