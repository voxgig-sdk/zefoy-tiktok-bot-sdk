...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/zefoy-tiktok-bot` | `npm install @voxgig-sdk/zefoy-tiktok-bot` |
| Python | `voxgig-sdk-zefoy-tiktok-bot` | `pip install voxgig-sdk-zefoy-tiktok-bot` |
| PHP | `voxgig-sdk/zefoy-tiktok-bot` | `composer require voxgig-sdk/zefoy-tiktok-bot` |
| Golang | `github.com/voxgig-sdk/zefoy-tiktok-bot-sdk/go` | `go get github.com/voxgig-sdk/zefoy-tiktok-bot-sdk/go` |
| Ruby | `voxgig-sdk-zefoy-tiktok-bot` | `gem install voxgig-sdk-zefoy-tiktok-bot` |
| Lua | `voxgig-sdk-zefoy-tiktok-bot` | `luarocks install voxgig-sdk-zefoy-tiktok-bot` |
