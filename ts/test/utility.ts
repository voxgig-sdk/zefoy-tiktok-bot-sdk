...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ZEFOY_TIKTOK_BOT_TEST_LIVE ||
    'TRUE' === process.env.ZEFOY_TIKTOK_BOT_TEST_OVERRIDE
  ) {
  ...
  m.ZEFOY_TIKTOK_BOT_TEST_EXPLAIN = process.env.ZEFOY_TIKTOK_BOT_TEST_EXPLAIN || m.ZEFOY_TIKTOK_BOT_TEST_EXPLAIN
