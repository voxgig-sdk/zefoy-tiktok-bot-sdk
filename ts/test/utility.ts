...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.ZEFOYTIKTOKBOT_TEST_LIVE ||
    'TRUE' === process.env.ZEFOYTIKTOKBOT_TEST_OVERRIDE
  ) {
  ...
  m.ZEFOYTIKTOKBOT_TEST_EXPLAIN = process.env.ZEFOYTIKTOKBOT_TEST_EXPLAIN || m.ZEFOYTIKTOKBOT_TEST_EXPLAIN
