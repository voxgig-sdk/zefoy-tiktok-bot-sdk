...
#      offline in seeded test mode (ZefoyTiktokBotSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "ZefoyTiktokBot_sdk.rb")
  SDK_CLASS = "ZefoyTiktokBotSDK"
