...
class EngagementEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set ZEFOY_TIKTOK_BOT_TEST_ENGAGEMENT_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def engagement_basic_setup(extra)
  ...
  entid_env_raw = ENV["ZEFOY_TIKTOK_BOT_TEST_ENGAGEMENT_ENTID"]
